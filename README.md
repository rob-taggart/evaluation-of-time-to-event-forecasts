...
Code and data to generate results and plots from the paper "Evaluating time-to-event forecasts under fixed-horizon right-censoring" by Robert J. Taggart, Nicholas Loveday and Simon Louis.
...
- `tte.py` contains code for scoring rules used in Sections 2 and 3 of the paper.
